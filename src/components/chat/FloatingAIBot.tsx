        ...
        {isChatOpen && (
          ...
          >
            ...
            <div className="px-4 py-2 space-y-2">
              <div className="flex items-center justify-center gap-1.5 py-1.5 px-3 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
                ...
                <span className="text-yellow-400/80 text-[10px] font-medium">AI CAN MAKE MISTAKE</span>
              </div>
              <a
